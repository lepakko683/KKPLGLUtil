...
public class Colour
{
    ...
    public Colour lighten(float amount)
    {
        ...
        this.red = clampFloat(this.red + amount, 0f, 1f);
        this.green = clampFloat(this.green + amount, 0f, 1f);
        this.blue = clampFloat(this.blue + amount, 0f, 1f);
        return this;
    }
    ...
    {
        this.red -= clampFloat((this.red - target.getRed()) * amount, 0f, 1f);
        this.green -= clampFloat((this.green - target.getGreen()) * amount, 0f, 1f);
        this.blue -= clampFloat((this.blue - target.getBlue()) * amount, 0f, 1f);
        if (tintAlpha)
        {
            this.alpha -= clampFloat((this.alpha - target.getAlpha()) * amount, 0f, 1f);
        }
        return this;
    }
